 ...
 * </p>
 */
public class JsonRequestBodyBeanPostProcessor implements BeanPostProcessor {
     ...
     */
    public JsonRequestBodyBeanPostProcessor() {
        ...
        if (bean instanceof RequestMappingHandlerAdapter) {
            ...
            for (int i = 0; i < argumentResolvers.size(); i++) {
                ...
                if (argumentResolver instanceof RequestResponseBodyMethodProcessor) {
                	...
                	JsonBodyArgumentResolver jsonRequestBodyArgumentResolver
                            = new JsonBodyArgumentResolver(
